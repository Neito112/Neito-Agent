...
// Auto-update latest Teyvat patch & meta when protocol starts
async function fetchLatestUpdates() {
  console.log("[Genshin Protocol] Auto-updating latest Teyvat & Natlan patch meta...");
  try {
    const knowledgeDaemon = require('../knowledge_daemon.js');
    await knowledgeDaemon.updateTopicKnowledge('genshin', 'Genshin Impact', 'Genshin Impact latest patch notes meta updates');
  } catch (err) {
    console.warn("[Genshin Protocol] Update notice:", err.message);
  }
}
