...
description: Ghi nhớ sự kiện/ưu tiên của Sếp, cập nhật khi có thông tin mới, dọn dữ liệu hết hạn.
category: agent-core
user-invocable: true
---
...
Ghi nhớ sự kiện/ưu tiên của Sếp, cập nhật khi có thông tin mới, dọn dữ liệu hết hạn.
