---
name: screen-reading
description: Khi OCR tổng thể nhiễu, chụp vùng cụ thể theo tọa độ/element và đọc nội dung cần quan tâm.
category: vision
user-invocable: true
---

# Đọc màn hình có chủ đích

Khi OCR tổng thể nhiễu, chụp vùng cụ thể theo tọa độ/element và đọc nội dung cần quan tâm.
