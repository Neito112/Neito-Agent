...
description: Viết test tối thiểu cho hành vi vừa sửa; chạy toàn bộ pipeline xác nhận trước khi báo xong.
...
Viết test tối thiểu cho hành vi vừa sửa; chạy toàn bộ pipeline xác nhận trước khi báo xong.
