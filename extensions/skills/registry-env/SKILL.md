---
name: registry-env
description: Đọc/ghi khóa registry có sao lưu trước khi sửa; đọc/đặt biến môi trường user và machine.
category: pc-operation
user-invocable: true
---

# Registry và biến môi trường

Đọc/ghi khóa registry có sao lưu trước khi sửa; đọc/đặt biến môi trường user và machine.
