---
name: docs-reading
description: Đọc doc/API/spec từ web hoặc file, trích đúng ràng buộc và phiên bản áp dụng.
category: research
user-invocable: true
---
...
Đọc doc/API/spec từ web hoặc file, trích đúng ràng buộc và phiên bản áp dụng.
