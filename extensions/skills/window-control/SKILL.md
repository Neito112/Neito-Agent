---
name: window-control
description: Mở, đóng, ẩn/hiện, đổi kích thước, di chuyển, đưa lên trước cửa sổ theo title/process qua WinAPI và PowerShell.
...
Mở, đóng, ẩn/hiện, đổi kích thước, di chuyển, đưa lên trước cửa sổ theo title/process qua WinAPI và PowerShell.
