---
name: network-diag
description: Test kết nối, DNS, cổng, proxy; đọc bảng định tuyến; xác định ứng dụng chiếm băng thông.
...
Test kết nối, DNS, cổng, proxy; đọc bảng định tuyến; xác định ứng dụng chiếm băng thông.
