---
name: file-ops
description: Tìm kiếm theo tên/nội dung, đọc/ghi/tạo/xóa/di chuyển bản sao có kiểm soát, quản lý thuộc tính, giải nén/nén archive.
...
Tìm kiếm theo tên/nội dung, đọc/ghi/tạo/xóa/di chuyển bản sao có kiểm soát, quản lý thuộc tính, giải nén/nén archive.
