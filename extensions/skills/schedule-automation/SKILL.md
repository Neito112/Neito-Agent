...
description: Tạo nhắc hẹn, job định kỳ, theo dõi mốc thời gian bằng scheduler hệ thống.
category: productivity
user-invocable: true
---

# Lịch và tự động hóa theo thời gian

Tạo nhắc hẹn, job định kỳ, theo dõi mốc thời gian bằng scheduler hệ thống.
