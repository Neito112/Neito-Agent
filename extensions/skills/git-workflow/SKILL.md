---
name: git-workflow
description: Commit đúng nhịp, nhánh an toàn, rebase/merge không mất lịch sử, tag save-point trước phát hành.
...
Commit đúng nhịp, nhánh an toàn, rebase/merge không mất lịch sử, tag save-point trước phát hành.
