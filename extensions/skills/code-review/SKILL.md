---
name: code-review
description: Đọc diff theo trục đúng-đủ-an toàn-tối giản; chỉ ra lỗi thực tế kèm vị trí, không duyệt suông.
...
Đọc diff theo trục đúng-đủ-an toàn-tối giản; chỉ ra lỗi thực tế kèm vị trí, không duyệt suông.
