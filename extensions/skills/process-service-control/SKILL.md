---
name: process-service-control
description: Liệt kê, tạm dừng, kết thúc tiến trình; bật/tắt/config service Windows; nhận diện tiến trình ngốn tài nguyên bất thường.
category: pc-operation
user-invocable: true
---

# Quản lý tiến trình và service

Liệt kê, tạm dừng, kết thúc tiến trình; bật/tắt/config service Windows; nhận diện tiến trình ngốn tài nguyên bất thường.
